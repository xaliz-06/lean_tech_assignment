...
const Report = ({ toggleFab }) => {
  ...
  //   Getting current location for the Feedback using window location
  // In case of Router, I would have used useLocation
  const currLocation = window.location.href;

  const thanks_msg = `Thanks for bringing the issue to our attention. We'll review it shortly and provide an update soon!`;
      ...
      {!submitted && (
        <>
          <h3 className={styles.header_text}>
            Let us know about the <span className={styles.special}>Issue</span>{" "}
